...
perm1 = PermutationalLayer(input, subnet = dense4_1)
perm2 = PermutationalLayer(perm1, subnet = dense4_2)
output = PermutationalLayer(perm2, subnet = dense4_3)
...
for epoch in range(20000):
	...
	f = open("error_perm3.txt","a")
	f.write("%d %.6g\n" % (epoch,err))
	f.close()
	
	pickle.dump(lasagne.layers.get_all_param_values(output),open("network_perm3.params","wb"))
